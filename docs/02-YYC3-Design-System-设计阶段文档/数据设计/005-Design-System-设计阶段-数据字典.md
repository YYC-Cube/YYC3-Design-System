---
@file: 005-Design-System-设计阶段-数据字典.md
@description: YYC3-Design-System 数据字典与元数据定义
...
# 02-YYC3-Design-System-设计阶段 - 数据设计 - 数据字典
...
本文档详细描述 YYC³(YanYuClouCube)-Design-System 02-YYC3-Design-System-设计阶段/数据设计-数据字典 相关内容，确保项目按照 YYC³ 标准规范进行开发和实施。
