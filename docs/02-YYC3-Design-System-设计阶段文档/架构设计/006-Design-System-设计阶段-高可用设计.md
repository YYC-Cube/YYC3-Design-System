---
@file: 006-Design-System-设计阶段-高可用设计.md
@description: YYC3-Design-System 系统高可用架构设计，包含容灾、备份、故障转移等
...
# 02-YYC3-Design-System-设计阶段 - 架构设计 - 高可用设计
...
本文档详细描述 YYC³(YanYuClouCube)-Design-System 02-YYC3-Design-System-设计阶段/架构设计-高可用设计 相关内容，确保项目按照 YYC³ 标准规范进行开发和实施。
