---
@file: 004-Design-System-运营与维护阶段-日志收集配置.md
@description: YYC3-Design-System 日志收集配置文档
...
# 06-YYC3-Design-System-运营与维护阶段 - 监控告警 - 日志收集配置
...
本文档详细描述 YYC³(YanYuClouCube)-Design-System 06-YYC3-Design-System-运营与维护阶段/监控告警-日志收集配置 相关内容，确保项目按照 YYC³ 标准规范进行开发和实施。
