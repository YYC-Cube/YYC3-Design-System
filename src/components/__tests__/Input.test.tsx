...
describe('Input 组件', () => {
  describe('基础渲染', () => {
    it('it('it('it('应该正确渲染默认输入框', () => {
      render(<ThemeProvider><Input />);
      const input = screen.getByRole('textbox');
      expect(input).toBeInTheDocument();
    });

    it('it('it('it('应该支持placeholder', () => {
  ...
  describe('可访问性', () => {
    ...
    it('it('it('it('应该支持自定义aria-describedby', () => {
      render(<ThemeProvider><Input aria-describedby="help-text" />);
      const input = screen.getByRole('textbox');
      expect(input).toHaveAttribute('aria-describedby', 'help-text');
    });

    it('it('it('it('应该支持自定义aria-invalid', () => {
  ...
  describe('ref', () => {
    ...
    it('it('it('it('应该能够通过ref访问input方法', () => {
      const ref = React.createRef<HTMLInputElement>();
      render(<ThemeProvider><Input ref={ref} />);
      ref.current?.focus();
