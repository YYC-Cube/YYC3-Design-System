...
export const Dropdown = memo<DropdownProps>(({
  ...
  const getPlacementStyles = (): React.CSSProperties => {
    ...
    switch (placement) {
      ...
      case 'bottomCenter':
        return { ...baseStyles, top: '100%', left: '50%', transform: 'translateX(-50%)', marginTop: '4px' };
      case 'bottomRight':
        return { ...baseStyles, top: '100%', right: 0, marginTop: '4px' };
      case 'topLeft':
        return { ...baseStyles, bottom: '100%', left: 0, marginBottom: '4px' };
      case 'topCenter':
        return { ...baseStyles, bottom: '100%', left: '50%', transform: 'translateX(-50%)', marginBottom: '4px' };
      case 'topRight':
    ...
    return (
      <div key={option.key}>
        {option.divider ? (
          ...
          <div
            style={{
              ...(option.disabled ? disabledOptionStyles : isActive ? activeOptionStyles : optionStyles),
